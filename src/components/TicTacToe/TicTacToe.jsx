...
import x_icon from '../../assets/x_main.png'
  ...
  const toggle = (e,num) =>{
    ...
    const checkWin = () =>{
      ...
      else if(data[2] === data[4] && data[4] === data[6] && data[6] !== "")
      {
        ...
        if(box_array !== "" && Count === 9){
          setLock(true);
          titleRef.current.innerHTML = "Match Drawn.Reset the game to play again";
      }
    }
    }
  ...
  return (
    <>
      <div className="container">
        <h3 className="title" ref={titleRef}>Tic-Tac-Toe using React</h3>
        <div className="board">
            <div className="row1">
